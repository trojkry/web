...
return [
    ...
    'filename' => 'C:/xampp/htdocs/grav-admin-v1.7.43/grav-admin/user/pages/03.opsec/default.md',
    'modified' => 1698212698,
    'size' => 8593,
    'data' => [
        'storage_key' => '03.opsec',
        'header' => [
            'title' => 'opsec'
        ],
        'root' => false,
        'name' => 'default.md',
        'frontmatter' => 'title: opsec
',
        'slug' => 'opsec',
        'ordering' => true,
        'markdown' => '## Opsec
...
* Je důležité si být vědom, že vytváření falešných identit je většinou neetické a může být nelegální. Falešné identity mohou být použity k podvodům, zneužívání osobních údajů a jiným nelegálním činnostem. Většina zemí má zákony, které trestají vytváření a používání falešných identit.
                ...
                * [Generátor falešných jmen](https://www.fakenamegenerator.com/)
                * [Generátor falešné identity](https://backgroundchecks.org/justdeleteme/fake-identity-generator/)
                * [Generátor náhodných jmen](https://randomuser.me/)
                * [Databáze obrázků](https://www.pexels.com/cs-cz/)
