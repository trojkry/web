...
return [
    ...
    'timestamp' => 1698210972,
    'checksum' => '4805af5d2f9ba64af49ca3a86cb42a79',
    'files' => [
        ...
        'user/themes' => [
            'themes/chalk' => [
                'file' => 'user/themes/chalk/blueprints.yaml',
                'modified' => 1698210938
            ],
            'themes/learn2' => [
            ...
            'themes/saba' => [
                'file' => 'user/themes/saba/blueprints.yaml',
                'modified' => 1698209670
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.chalk.blog_theme' => [
                ...
                'name' => 'themes.chalk.blog_theme',
                'validation' => 'loose'
            ],
            'themes.chalk.summary_enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.chalk.summary_enabled',
                'validation' => 'loose'
            ],
            'themes.chalk.header_font' => [
                'type' => 'toggle',
                'label' => 'Header font',
                'default' => 'cormorant',
                'options' => [
                ...
                'name' => 'themes.chalk.header_font',
                'validation' => 'loose'
            ],
            'themes.chalk.body_width' => [
                'type' => 'text',
                'label' => 'Custom body width',
                'default' => '',
                'name' => 'themes.chalk.body_width',
                'validation' => 'loose'
            ],
            'themes.chalk.footer_text' => [
                'type' => 'textarea',
                'style' => 'vertical',
                'label' => 'Footer Text',
                ...
                'name' => 'themes.chalk.footer_text',
                'validation' => 'loose'
            ],
            'themes.chalk.social_twitter' => [
                'type' => 'text',
                'label' => 'Twitter ID <i class="fa fa-twitter"></i>',
                'name' => 'themes.chalk.social_twitter',
                'validation' => 'loose'
            ],
            'themes.chalk.social_facebook' => [
                'type' => 'text',
                'label' => 'Facebook ID <i class="fa fa-facebook"></i>',
                'name' => 'themes.chalk.social_facebook',
                'validation' => 'loose'
            ],
            'themes.chalk.social_medium' => [
                'type' => 'text',
                'label' => 'Medium ID <i class="fa fa-medium"></i>',
                'name' => 'themes.chalk.social_medium',
                'validation' => 'loose'
            ],
            'themes.chalk.social_github' => [
                'type' => 'text',
                'label' => 'Github ID  <i class="fa fa-github"></i>',
                'name' => 'themes.chalk.social_github',
                'validation' => 'loose'
            ],
            'themes.chalk.social_gitlab' => [
                'type' => 'text',
                'label' => 'Gitlab ID <i class="fa fa-gitlab"></i>',
                'name' => 'themes.chalk.social_gitlab',
                'validation' => 'loose'
            ],
            'themes.chalk.social_bitbucket' => [
                'type' => 'text',
                'label' => 'Bitbucket ID <i class="fa fa-bitbucket"></i>',
                'name' => 'themes.chalk.social_bitbucket',
                'validation' => 'loose'
            ],
            'themes.chalk.social_stackoverflow' => [
                'type' => 'text',
                'label' => 'Stackoverflow ID <i class="fa fa-stack-overflow"></i>',
                'name' => 'themes.chalk.social_stackoverflow',
                'validation' => 'loose'
            ],
            'themes.chalk.social_keybase' => [
                'type' => 'text',
                'label' => 'Keybase ID <i class="fa fa-keybase"></i>',
                'name' => 'themes.chalk.social_keybase',
                'validation' => 'loose'
            ],
            'themes.chalk.social_docker' => [
                'type' => 'text',
                'label' => 'Docker ID <i class="fa fa-docker"></i>',
                'name' => 'themes.chalk.social_docker',
                'validation' => 'loose'
            ],
            'themes.chalk.social_linkedin' => [
                'type' => 'text',
                'label' => 'Linkedin ID <i class="fa fa-linkedin"></i>',
                'name' => 'themes.chalk.social_linkedin',
                'validation' => 'loose'
            ],
            'themes.chalk.social_dribbble' => [
                'type' => 'text',
                'label' => 'Dribbble Twitter ID <i class="fa fa-dribbble"></i>',
                'name' => 'themes.chalk.social_dribbble',
                'validation' => 'loose'
            ],
            'themes.chalk.social_spotify' => [
                'type' => 'text',
                'label' => 'Spotify ID <i class="fa fa-spotify"></i>',
                'name' => 'themes.chalk.social_spotify',
                'validation' => 'loose'
            ],
            'themes.chalk.social_youtube' => [
                'type' => 'text',
                'label' => 'Youtube ID <i class="fa fa-youtube"></i>',
                'name' => 'themes.chalk.social_youtube',
                'validation' => 'loose'
            ],
            'themes.chalk.social_twitch' => [
                'type' => 'text',
                'label' => 'Twitch ID <i class="fa fa-twitch"></i>',
                'name' => 'themes.chalk.social_twitch',
                'validation' => 'loose'
            ],
            'themes.chalk.social_steam' => [
                'type' => 'text',
                'label' => 'Steam ID <i class="fa fa-steam"></i>',
                'name' => 'themes.chalk.social_steam',
                'validation' => 'loose'
            ],
            'themes.chalk.social_discord' => [
                'type' => 'text',
                'label' => 'Discord ID <i class="fa fa-discord"></i>',
                'name' => 'themes.chalk.social_discord',
                'validation' => 'loose'
            ],
            'themes.chalk.social_bitcoin' => [
                'type' => 'text',
                'label' => 'Bitcoin Address <i class="fa fa-bitcoin"></i>',
                'name' => 'themes.chalk.social_bitcoin',
                'validation' => 'loose'
            ],
            'themes.chalk.social_ethereum' => [
                'type' => 'text',
                'label' => 'Ethereum Address <i class="fa fa-ethereum"></i>',
                'name' => 'themes.chalk.social_ethereum',
                'validation' => 'loose'
            ],
            'themes.chalk.social_email' => [
                'type' => 'text',
                'label' => 'Email Address <i class="fa fa-envelope"></i>',
                'name' => 'themes.chalk.social_email',
                'validation' => 'loose'
            ],
            'themes.chalk.social_flickr' => [
                'type' => 'text',
                'label' => 'Flickr ID <i class="fa fa-flicker"></i>',
                'name' => 'themes.chalk.social_flickr',
                'validation' => 'loose'
            ],
            'themes.chalk.social_instagram' => [
                'type' => 'text',
                'label' => 'Instagram ID <i class="fa fa-instagram"></i>',
                'name' => 'themes.chalk.social_instagram',
                'validation' => 'loose'
            ],
            'themes.chalk.social_tumblr' => [
                'type' => 'text',
                'label' => 'Tumblr ID <i class="fa fa-tumblr"></i>',
                'name' => 'themes.chalk.social_tumblr',
                'validation' => 'loose'
            ],
            'themes.learn2' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                'chalk' => [
                    'blog_theme' => 'themes.chalk.blog_theme',
                    'summary_enabled' => 'themes.chalk.summary_enabled',
                    'header_font' => 'themes.chalk.header_font',
                    'body_width' => 'themes.chalk.body_width',
                    'footer_text' => 'themes.chalk.footer_text',
                    'social_twitter' => 'themes.chalk.social_twitter',
                    'social_facebook' => 'themes.chalk.social_facebook',
                    'social_medium' => 'themes.chalk.social_medium',
                    'social_github' => 'themes.chalk.social_github',
                    'social_gitlab' => 'themes.chalk.social_gitlab',
                    'social_bitbucket' => 'themes.chalk.social_bitbucket',
                    'social_stackoverflow' => 'themes.chalk.social_stackoverflow',
                    'social_keybase' => 'themes.chalk.social_keybase',
                    'social_docker' => 'themes.chalk.social_docker',
                    'social_linkedin' => 'themes.chalk.social_linkedin',
                    'social_dribbble' => 'themes.chalk.social_dribbble',
                    'social_spotify' => 'themes.chalk.social_spotify',
                    'social_youtube' => 'themes.chalk.social_youtube',
                    'social_twitch' => 'themes.chalk.social_twitch',
                    'social_steam' => 'themes.chalk.social_steam',
                    'social_discord' => 'themes.chalk.social_discord',
                    'social_bitcoin' => 'themes.chalk.social_bitcoin',
                    'social_ethereum' => 'themes.chalk.social_ethereum',
                    'social_email' => 'themes.chalk.social_email',
                    'social_flickr' => 'themes.chalk.social_flickr',
                    'social_instagram' => 'themes.chalk.social_instagram',
                    'social_tumblr' => 'themes.chalk.social_tumblr'
                ],
                'learn2' => [
